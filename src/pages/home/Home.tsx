...
const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // 3. Fetch Featured Products (Max 4 products)
  ...
  return (
    <>
      ...
      {/* ================= HERO SECTION (3D) ================= */}
      <div className="relative h-[calc(100vh-80px)] w-full bg-[#f8fafc] overflow-hidden flex flex-col md:flex-row items-center border-b border-gray-100">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pointer-events-auto flex items-center justify-center md:justify-start h-full pb-20 md:pb-0 pt-10 md:pt-0">
          <div className="max-w-2xl text-center md:text-left mt-auto md:mt-0">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 tracking-tight leading-[1.1] flex flex-wrap justify-center md:justify-start gap-x-3">
            ...
            <p className="text-gray-600 text-lg md:text-xl mb-12 max-w-md mx-auto md:mx-0 leading-relaxed font-medium bg-white/40 p-4 rounded-2xl backdrop-blur-sm border border-white/60 shadow-sm animate-fade-in-up" style={{ animationDelay: '1.8s', opacity: 0 }}>
              Discover our exclusive interactive collection. Experience premium luxury and craftsmanship like never before.
            </p>
      ...
      {/* ================= NEW ARRIVALS ================= */}
      <div className="bg-[#F8FAFC] py-24 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* 
            ব্যানার ইমেজটি public ফোল্ডারে /my-banner.jpg নামে রাখলে এটি অটোমেটিক কাজ করবে।
            যদি ছবি না থাকে, তবে onError ফাংশন একটি ডেমো সুন্দর ইমেজ লোড করে দেবে।
          */}
      ...
      {/* ================= FEATURED PRODUCTS ================= */}
      <div className="bg-[#F8FAFC] py-24 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-10">
            <div>
