  ...
  return (
    <>
      ...
      <div className="relative min-h-[calc(100vh-80px)] w-full bg-[#f8fafc] overflow-hidden flex flex-col md:flex-row items-center justify-center cursor-grab active:cursor-grabbing pb-10 md:pb-0">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pointer-events-none flex items-center justify-center md:justify-start h-full -pt-50 md:pt-0 pb-12 md:pb-0">
